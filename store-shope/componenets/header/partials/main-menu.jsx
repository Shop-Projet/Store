    ...
    <nav className="main-nav">
      <ul className="menu sf-arrows">
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      ...
                      <ul>
                        ...
                        >
                          <ALink href="/shop/sidebar/list" scroll={false}>
                            Shop List
                          </ALink>
                        </li>
                        <li
        ...
        <li className={path.indexOf("blog/") > -1 ? "active" : ""}>
          <ALink href="/blog/classic" className="sf-with-ul">
            Categories
          </ALink>

          <ul>
            <li className={path.indexOf("blog/classic") > -1 ? "active" : ""}>
              <ALink href="/blog/classic">Naissance</ALink>
            </li>
            <li className={path.indexOf("blog/listing") > -1 ? "active" : ""}>
              <ALink href="/blog/listing">Jeux d'éveils</ALink>
            </li>

            <li className={path.indexOf("blog/listing") > -1 ? "active" : ""}>
              <ALink href="/blog/listing">Jeux Educatifs </ALink>
            </li>

            <li className={path.indexOf("blog/listing") > -1 ? "active" : ""}>
              <ALink href="/blog/listing">Jeux Creatifs</ALink>
            </li>

            <li className={path.indexOf("blog/listing") > -1 ? "active" : ""}>
              <ALink href="/blog/listing">Jeux de Construction</ALink>
            </li>

            <li className={path.indexOf("blog/listing") > -1 ? "active" : ""}>
              <ALink href="/blog/listing">Sport et Activité plein air</ALink>
            </li>

            <li className={path.indexOf("blog/listing") > -1 ? "active" : ""}>
              <ALink href="/blog/listing">Media et Jeux Video</ALink>
            </li>

            <li className={path.indexOf("blog/listing") > -1 ? "active" : ""}>
              <ALink href="/blog/listing">Scolaire</ALink>
            </li>

            <li className={path.indexOf("blog/listing") > -1 ? "active" : ""}>
              <ALink href="/blog/listing">Decoration</ALink>
            </li>

            <li className={path.indexOf("blog/listing") > -1 ? "active" : ""}>
              <ALink href="/blog/listing">Livres</ALink>
            </li>

            {/* <li className={path.indexOf("blog/grid") > -1 ? "active" : ""}>
              <ALink href="/blog/grid/2cols" className="sf-with-ul">
                Grid
              </ALink>
              <ul>
                <li
                ...
                >
                  <ALink href="/blog/grid/2cols">Grid 2 columns</ALink>
                </li>
                <li
                  className={
                ...
                >
                  <ALink href="/blog/grid/3cols">Grid 3 columns</ALink>
                </li>
                <li
                  className={
                ...
                >
                  <ALink href="/blog/grid/4cols">Grid 4 columns</ALink>
                </li>
                <li
                  className={
                ...
                >
                  <ALink href="/blog/grid/sidebar">Grid sidebar</ALink>
                </li>
              </ul>
            </li> */}
            {/* <li className={path.indexOf("blog/masonry") > -1 ? "active" : ""}>
              <ALink href="/blog/masonry/2cols" className="sf-with-ul">
                Masonry
              </ALink>
              <ul>
                <li
                ...
                >
                  <ALink href="/blog/masonry/2cols">Masonry 2 columns</ALink>
                </li>
                <li
                  className={
                ...
                >
                  <ALink href="/blog/masonry/3cols">Masonry 3 columns</ALink>
                </li>
                <li
                  className={
                ...
                >
                  <ALink href="/blog/masonry/4cols">Masonry 4 columns</ALink>
                </li>
                <li
                  className={
                ...
                >
                  <ALink href="/blog/masonry/sidebar">Masonry sidebar</ALink>
                </li>
              </ul>
            </li> */}
            {/* <li className={path.indexOf("blog/mask") > -1 ? "active" : ""}>
              <ALink href="/blog/mask/grid" className="sf-with-ul">
                Mask
              </ALink>
              <ul>
                <li
                ...
                >
                  <ALink href="/blog/mask/grid">Blog Mask Grid</ALink>
                </li>
                <li
                  className={
                ...
                >
                  <ALink href="/blog/mask/masonry">Blog Mask Masonry</ALink>
                </li>
              </ul>
            </li> */}
            {/* <li className={path.indexOf("blog/single") > -1 ? "active" : ""}>
              ...
              <ul>
                ...
                >
                  <ALink href="/blog/single/default/cras-ornare-tristique-elit.">
                ...
                >
                  <ALink href="/blog/single/fullwidth/fusce-pellentesque-suscipit.">
                ...
                >
                  <ALink href="/blog/single/sidebar/utaliquam-sollicitzdvudin-leo">
