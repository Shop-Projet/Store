                    ...
                    <div className="row">
                        <div className="col-lg-10 offset-lg-1">
                            ...
                            <div>
                                ...
                                <textarea className="form-control validate" rows="10" required  placeholder="Ex: Je vends cette poussette avec habillage pluie ..." onChange={e=> setDescription(e.target.value)}></textarea>
                            </div>
                            </div>
                            <div className="col-lg-6 col-sm-6 ">
                            <div>
                                <label htmlFor="etat">Sex</label>
                                <br/>
                                    <select id="etat" className="form-control form-select"  onChange={e => {setSex(e.target.value);}} required >
                                        <option value="" disabled selected hidden>Séléctionner ...</option>
                            ...
                            { categorie === "jouets" ?
                                <div >
                                    ...
                                    <br/>
                                    <select  id="category" className="form-control form-select"  onChange={e => {setSousCategorieJeux(e.target.value);}} required>
                                        <option value="" disabled selected hidden>Séléctionner une Sous Catégorie</option>
                                        ...
                                        <option value="Sport et activités en plein air">Sport et activités en plein air</option>
                                    </select>
                                </div> : categorie  === "vêtements" ?
                                <div >
                                <label htmlFor="category" >Sous Catégorie</label>
                                <br/>
                                <select  id="category" className="form-control form-select"  onChange={e => {setSousCategorieVetements(e.target.value);}} required>
                                    <option value="" disabled selected hidden>Séléctionner une Sous Catégorie</option>
                                    <option value="Vêtements bébé">Vêtements bébé</option>
                                    <option value="Manteaux et vestes">Manteaux et vestes</option>
                            ...
                            <div className="form-group mb-3">
                                ...
                                <i className="icon-long-arrow-right"></i>
                                    <span>{' '}Tu gagnes si vendu : {prix? (prix*0.8).toFixed(2) : "0 "} DT (80% du prix)</span>
                                </div>
                            </div>
